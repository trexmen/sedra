<?php
$aksi="modul/siswa/aksi-siswa.php";
switch($_GET['act'])
{
  default:
echo"
<div style='width:765px;padding-bottom:5px;'>
	...
	<input type='hidden' name='modul' value='siswa'>
	<tr>
	...
	if (empty($_GET['kata']))
	{
	    ...
	    while($r=mysql_fetch_array($tampil))
	    {
			...
			<tr style='$warna'>
				...
				<td>".$r['nama']."</td>
				<td>
					<a href='?modul=siswa&act=detail&nis=$r[nis]'>DETAIL</a>
				</td>
			</tr>
			";
	          $no++;
 	...
 	else
  	{
	    ...
	    while($r=mysql_fetch_array($tampil))
	    {
			...
			<tr style='$warna'>
				...
				<td>".$r['nama']."</td>
				<td>
					<a href='?modul=siswa&nis=$r[nis]'>DETAIL</a>
				</td>
			</tr>
			";
	          $no++;
